    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="mr-auto">
        ...
        <NavDropdown title="Inventory" id="basic-nav-dropdown">
            ...
            <NavDropdown.Item href="#action/3.2">View Summary</NavDropdown.Item>
        </NavDropdown>

        <NavDropdown title="Sales/Out Challan" id="basic-nav-dropdown">
            <NavDropdown.Item href="#action/3.1">View Challans</NavDropdown.Item>
            <NavDropdown.Item href="#action/3.2">Verify Challans</NavDropdown.Item>
        </NavDropdown>
